...
$reboot = ($CompPendRen -or $CBSRebootPend -or $WUAURebootReq -or $SCCM)
...
##      Write-Host 'CompPendRen - '$CompPendRen
##      Write-Host 'CBSRebootPend - '$CBSRebootPend
##      Write-Host 'WUAURebootReq - '$WUAURebootReq
##      Write-Host 'SCCM - '$SCCM
##      Write-Host 'PendFileRename - '$PendFileRename
        return $true
    } else {
